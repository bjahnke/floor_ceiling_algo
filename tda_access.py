...
class OrderData:
    OPEN_ORDER = {
        ...
        strategy_utils.Side.SHORT: lambda sym, qty, _: toe.equity_sell_short_market(
            sym, qty
        ),
    }
    ...
    CLOSE_ORDER = {
        ...
        strategy_utils.Side.SHORT: lambda sym, qty, _: toe.equity_buy_to_cover_market(
            sym, qty
        ),
    }
